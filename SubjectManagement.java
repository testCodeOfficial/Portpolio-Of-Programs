                ...
                for (int i = forSubjects.size() - 1; i >= 0; i--) {
                    ...
                    if (subject.length > 2) {
                        ...
                        if (deletionOfSubject.endsWith(deleteCode)) {
                            ...
                            System.out.printf(
                                    "Admin: Are you sure you want to delete this subject we need as confirmation.\nChoice [Y/N]: ");
                    ...
                    case "I":
                        ...
                        if (matchingInstructor(assignSubj)) {
                            ...
                            for (String[] assignment : forSubjects) {
                                if (assignment.length > 5 && assignment[5] != null && assignment[5].equals(assignSubj)
                                        && assignment[2].equals(insSub)) {
                                    alreadyHave = true;
                                    break;
                                }
                            }
                            ...
                            if (!alreadyHave) {
                                ...
                                System.out.println(
                                        "Subject " + insSub + " is already assigned to instructor " + assignSubj);
                            }
            ...
            if (subjectSearched.isBlank()) {
                ...
                for (String[] subject : forSubjects) {
                    if (subject.length > 2 &&
                        ...
                        System.out.println("\nSubject Found:");
                        System.out.println("Title:          " + subject[0].toUpperCase());
                        System.out.println("Description:    " + subject[1].toUpperCase());
